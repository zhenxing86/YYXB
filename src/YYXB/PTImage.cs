...
namespace YYXB.Core
{
    ...
    public class PTImage
    {
        ...
        public static void CutForSquare(string postedFile, string fileSaveUrl, int side, int quality)
        {
            //创建目录
            ...
            System.Drawing.Image initImage = System.Drawing.Image.FromFile(postedFile, true);
        ...
        /// <param name="quality">质量（范围0-100）</param>
        public static void CutForCustom(string postedFile, string fileSaveUrl, int maxWidth, int maxHeight, int quality)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    System.Drawing.Graphics templateG = System.Drawing.Graphics.FromImage(templateImage);
                    templateG.InterpolationMode = System.Drawing.Drawing2D.InterpolationMode.High;
                    //templateG.InterpolationMode = System.Drawing.Drawing2D.InterpolationMode.Low;
                    templateG.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.HighQuality;
                  
                    templateG.Clear(Color.WhiteSmoke);
        ...
        public static void ZoomAuto(string postedFile, string savePath, System.Double targetWidth, System.Double targetHeight, string watermarkText, string watermarkImage)
        {
            //创建目录
